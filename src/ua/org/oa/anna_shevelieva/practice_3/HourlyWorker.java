...
public class HourlyWorker extends Employee{
    ...
    public HourlyWorker( String first, String last, String position,  double hourlyWage, double hoursWorked )
    {
       super( first, last, position);
       setWage( hourlyWage ); // validate hourly wage
       setHours( hoursWorked ); // validate hours worked
    } // end five-argument HourlyWorker constructor
    ...
    if ( getHours() <= 40 ) // no overtime
        ...
        // return String representation of HourlyWorker object
    @Override
